        ...
        <>
            ...
            <div className="justify-content-center align-items-center">
                <div className="card-body__upper d-flex flex-column">
                    <h5 className="color-white font-size20 line-height-30 font-weight800 letter-spacing-2">
                        Free Bundle: Gain access to our challenges
                        Premium: Unlimited attempts on challenges
                        Premium+: Submit your own challenges to others on the websites
                    </h5>
                    <p className="font-size18 line-height-26 font-weight600 flex-grow-1">
